...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_PINKY_REACH_CMK] = LAYOUT(
        ...
        KC_Q, KC_G, KC_W, KC_F, KC_P, KC_NO,KC_NO, KC_L, KC_U, KC_Y, KC_J, KC_MINS,
        KC_D, LG(KC_A), LA(KC_R), LC(KC_S), LS(KC_T), KC_NO,KC_NO, LS(KC_N), RC(KC_E), RA(KC_I), RG(KC_O), KC_H,
        KC_B, KC_Z, KC_X, KC_C, SYMB(KC_V), KC_NO,KC_NO, SYMB(KC_M), KC_K, KC_COMM, KC_DOT, KC_QUOT,
        QK_REP, DM_REC1, DM_PLY1, NUM(KC_DEL), LS(KC_BSPC), SYMB(KC_ESC),KC_ENT, MVMT(KC_SPC), MOUSE(KC_TAB), DM_REC2, DM_PLY2, TO(_MOUSE)
    ...
    [_MVMT] = LAYOUT(
        ...
        KC_BSPC, KC_LGUI, KC_LALT, KC_LCTL, KC_LSFT, KC_NO,KC_NO, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_ENT,
        KC_DEL, C(KC_Z), C(KC_A), C(KC_C), C(KC_V), KC_NO,KC_NO, KC_LPRN, KC_LBRC, KC_RBRC, KC_RPRN, KC_BSLS,
        KC_NO, KC_NO, KC_NO, KC_ENT, KC_SPC, KC_ESC,KC_NO, KC_TRNS, KC_NO, KC_NO, KC_NO, TO(0)
