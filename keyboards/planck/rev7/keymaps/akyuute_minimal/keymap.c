...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_MOUSE] = LAYOUT(
        ...
        KC_DEL, KC_NO, KC_NO, KC_SPC, KC_LSFT, MEDIA(KC_ESC),KC_ENT, KC_NO, KC_TRNS, KC_NO, KC_NO, TO(0)
    ...
    [_MEDIA] = LAYOUT(
        ...
        KC_NO, KC_NO, KC_NO, KC_NO, MO(_ADJUST), KC_TRNS,KC_NO, MO(_ADJUST), KC_TRNS, KC_NO, KC_NO, TO(0)
