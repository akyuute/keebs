...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_SYMB] = LAYOUT_all(
        ...
        KC_LSFT, KC_TAB, KC_LALT, KC_LCTL, KC_LSFT, KC_LGUI, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_TILD, KC_RSFT,KC_TRNS,KC_TRNS,
    ...
    [_MOUSE] = LAYOUT_all(
        ...
        KC_ENT, MS_LEFT, MS_DOWN, MS_RGHT, MS_WHLL, MS_WHLD, MS_WHLR, KC_NO, KC_NO, KC_NO, MS_ACL0, MS_ACL2, MS_BTN6,
        KC_LSFT, LSFT(KC_TAB), KC_TAB, DT_DOWN, DT_UP, KC_NO, KC_NO, KC_NO, KC_NO, MS_BTN4, MS_BTN5, MS_BTN3,KC_NO,KC_NO,
        KC_LCTL, KC_LGUI, MO(_SPEC), KC_SPC, MS_BTN1, MS_BTN2, MS_ACL0, KC_TRNS
    ),
